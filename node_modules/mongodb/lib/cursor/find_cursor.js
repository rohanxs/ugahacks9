...
class FindCursor extends abstract_cursor_1.AbstractCursor {
    ...
    addQueryModifier(name, value) {
        abstract_cursor_1.assertUninitialized(this);
        if (name[0] !== '$') {
            throw new error_1.MongoError(`${name} is not a valid query modifier`);
        }
        // Strip of the $
    ...
    maxAwaitTimeMS(value) {
        ...
        if (typeof value !== 'number') {
            throw new error_1.MongoError('maxAwaitTimeMS must be a number');
        }
    ...
    maxTimeMS(value) {
        abstract_cursor_1.assertUninitialized(this);
        if (typeof value !== 'number') {
            throw new error_1.MongoError('maxTimeMS must be a number');
        }
        this[kBuiltOptions].maxTimeMS = value;
        return this;
    }
    ...
    sort(sort, direction) {
        ...
        if (this[kBuiltOptions].tailable) {
            throw new error_1.MongoError('Tailable cursor does not support sorting');
        }
    ...
    allowDiskUse() {
        ...
        if (!this[kBuiltOptions].sort) {
            throw new error_1.MongoError('allowDiskUse requires a sort specification');
        }
    ...
    limit(value) {
        abstract_cursor_1.assertUninitialized(this);
        if (this[kBuiltOptions].tailable) {
            throw new error_1.MongoError('Tailable cursor does not support limit');
        }
        if (typeof value !== 'number') {
    ...
    skip(value) {
        abstract_cursor_1.assertUninitialized(this);
        if (this[kBuiltOptions].tailable) {
            throw new error_1.MongoError('Tailable cursor does not support skip');
        }
        if (typeof value !== 'number') {
