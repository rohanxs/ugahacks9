...
class InsertOperation extends command_1.CommandOperation {
    constructor(ns, documents, options) {
        ...
        this.options = { ...options, checkKeys: (_a = options.checkKeys) !== null && _a !== void 0 ? _a : true };
        this.ns = ns;
...
class InsertManyOperation extends operation_1.AbstractOperation {
    ...
    execute(server, session, callback) {
        ...
        const bulkWriteOperation = new bulk_write_1.BulkWriteOperation(coll, [{ insertMany: common_functions_1.prepareDocs(coll, this.docs, options) }], options);
