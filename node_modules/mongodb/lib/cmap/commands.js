...
class Response {
    constructor(message, msgHeader, msgBody, opts) {
        ...
        this.raw = message;
        this.data = msgBody;
        this.opts = opts !== null && opts !== void 0 ? opts : { promoteLongs: true, promoteValues: true, promoteBuffers: false };
    ...
    parse(options) {
        ...
        while (this.index < this.data.length) {
            ...
            if (payloadType === 0) {
                ...
                throw new error_1.MongoError('OP_MSG Payload Type 1 detected unsupported protocol');
            }
        }
        if (this.documents.length === 1 && documentsReturnedIn != null && raw) {
            const fieldsAsRaw = {};
