...
exports.CMAP_EVENT_NAMES = exports.ConnectionPool = void 0;
        ...
        while (this.waitQueueSize) {
            ...
            if (waitQueueMember) {
                ...
                if (!waitQueueMember[kCancelled]) {
                    waitQueueMember.callback(new error_1.MongoError('connection pool closed'));
                }
            }
        }
...
function createConnection(pool, callback) {
    ...
    connect_1.connect(connectOptions, (err, connection) => {
        ...
        utils_1.relayEvents(connection, pool, [
