...
function maxStalenessReducer(readPreference, topologyDescription, servers) {
    ...
    if (maxStaleness < maxStalenessVariance) {
        throw new error_1.MongoError(`maxStalenessSeconds must be at least ${maxStalenessVariance} seconds`);
    }
    if (maxStaleness < SMALLEST_MAX_STALENESS_SECONDS) {
        throw new error_1.MongoError(`maxStalenessSeconds must be at least ${SMALLEST_MAX_STALENESS_SECONDS} seconds`);
    }
...
function readPreferenceServerSelector(readPreference) {
    ...
    return (topologyDescription, servers) => {
        ...
        if (commonWireVersion &&
            ...
            throw new error_1.MongoError(`Minimum wire version '${readPreference.minWireVersion}' required, but found '${commonWireVersion}'`);
        }
