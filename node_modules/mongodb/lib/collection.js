...
class Collection {
    ...
    bulkWrite(operations, options, callback) {
        ...
        if (!Array.isArray(operations)) {
            throw new error_1.MongoError('operations must be an array of documents');
        }
    ...
    rename(newName, options, callback) {
        ...
        return execute_operation_1.executeOperation(utils_2.getTopology(this), new rename_1.RenameOperation(this, newName, { ...options, readPreference: read_preference_1.ReadPreference.PRIMARY }), callback);
    }
    ...
    findOne(query, options, callback) {
        ...
        if (typeof options === 'function')
            (callback = options), (options = {});
        query = query || {};
        return execute_operation_1.executeOperation(utils_2.getTopology(this), new find_one_1.FindOneOperation(this, query, utils_1.resolveOptions(this, options)), callback);
    }
    find(filter, options) {
    ...
    countDocuments(query, options, callback) {
        ...
        query = query || {};
        return execute_operation_1.executeOperation(utils_2.getTopology(this), new count_documents_1.CountDocumentsOperation(this, query, utils_1.resolveOptions(this, options)), callback);
    }
    distinct(key, query, options, callback) {
        ...
        query = query || {};
        return execute_operation_1.executeOperation(utils_2.getTopology(this), new distinct_1.DistinctOperation(this, key, query, utils_1.resolveOptions(this, options)), callback);
    }
    ...
    count(query, options, callback) {
        ...
        query = query || {};
        return execute_operation_1.executeOperation(utils_2.getTopology(this), new estimated_document_count_1.EstimatedDocumentCountOperation(this, query, utils_1.resolveOptions(this, options)), callback);
    }
}
