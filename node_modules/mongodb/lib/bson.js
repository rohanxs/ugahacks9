...
exports.resolveBSONOptions = exports.pluckBSONSerializeOptions = exports.calculateObjectSize = exports.serialize = exports.deserialize = exports.Map = exports.BSONSymbol = exports.BSONRegExp = exports.DBRef = exports.Double = exports.Int32 = exports.Decimal128 = exports.MaxKey = exports.MinKey = exports.Code = exports.Timestamp = exports.ObjectId = exports.Binary = exports.Long = void 0;
...
function pluckBSONSerializeOptions(options) {
    const { fieldsAsRaw, promoteValues, promoteBuffers, promoteLongs, serializeFunctions, ignoreUndefined, raw } = options;
    return {
        fieldsAsRaw,
        promoteValues,
        promoteBuffers,
...
function resolveBSONOptions(options, parent) {
    ...
    return {
        ...
        serializeFunctions: (_m = (_l = options === null || options === void 0 ? void 0 : options.serializeFunctions) !== null && _l !== void 0 ? _l : parentOptions === null || parentOptions === void 0 ? void 0 : parentOptions.serializeFunctions) !== null && _m !== void 0 ? _m : false,
        fieldsAsRaw: (_p = (_o = options === null || options === void 0 ? void 0 : options.fieldsAsRaw) !== null && _o !== void 0 ? _o : parentOptions === null || parentOptions === void 0 ? void 0 : parentOptions.fieldsAsRaw) !== null && _p !== void 0 ? _p : {}
    };
}
