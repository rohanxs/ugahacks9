 ...
 * ```
 */
class MongoClient extends events_1.EventEmitter {
    ...
    db(dbName, options) {
        ...
        if (!this.topology) {
            throw new error_1.MongoError('MongoClient must be connected before calling MongoClient.prototype.db');
        }
    ...
    startSession(options) {
        ...
        if (!this.topology) {
            throw new error_1.MongoError('Must connect to a server before calling this method');
        }
